...
2. On first activate, the extension migrates `ontocode.*` settings, workspaceState keys, and `.ontocode/session.json` when present.
...
- [ ] Settings and saved queries preserved
