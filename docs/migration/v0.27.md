...
| VS Code extension | `strixonomy.strixonomy` | **`strixonomy.strixonomy`** |
...
3. Disable or uninstall the old **OntoCode** (`strixonomy.strixonomy`) listing to avoid duplicate commands.
