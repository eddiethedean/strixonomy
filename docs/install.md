...
| Release VSIX (`strixonomy-v0.28.1.vsix`) | Same | No |
...
See [CI integration](ci-integration.md) — download `strixonomy-v0.28.1-x86_64-unknown-linux-gnu.tar.gz`, verify `SHA256SUMS`, run `validate` / `classify`.
