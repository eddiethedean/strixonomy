...
| plugin platform (SDK 1.0; marketplace/workflows v0.33) |
+------+--------+-----------+
       |        |           |
       v        v           v
+-----------+ +-----------+ +------------------+
...
- **v0.30:** joins/aggregations via extended virtual tables first; DataFusion if triggered ([ADR-0011](adr/0011-use-sqlparser-for-sql.md) amendment)
...
- v0.30: `ontologos-*` 1.0.0 (`dl`, `facade`, full DL explanations)
...
LSP lifecycle; protocol guards; v0.30 authoring methods.
