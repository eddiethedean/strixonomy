...
Primary anchors: [ROADMAP.md](../roadmap.md) § v0.27 · [PRE_1_0_PHASES.md](../protege-parity/07_BACKLOG/PRE_1_0_PHASES.md) · [ADR-0022](adr/0022-strixonomy-identity.md).
...
- [x] Activate-time migration from OntoCode settings / workspaceState / `.ontocode/session.json`
...
- [ ] Deprecate Marketplace listing `ontocode.ontocode` with pointer to Strixonomy
...
- Existing v0.26 user upgrades without silent loss of settings, workspace state, plugins, or CI compatibility
