...
Primary anchors: [ROADMAP.md](../roadmap.md) § v0.27 · [V0_30_PHASES.md](https://github.com/eddiethedean/strixonomy/blob/main/docs/protege-parity/07_BACKLOG/V0_30_PHASES.md) · [ADR-0022](adr/0022-strixonomy-identity.md).

## Theme

Rename OntoCore and OntoCode to **Strixonomy** before the v0.30 identity and APIs freeze, with a dual-read compatibility window for v0.26 users.
...
- Protégé parity feature work / v0.29 stabilization
