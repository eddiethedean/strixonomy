...
|----------|---------|----------|--------|
| [SHIPPED.md](SHIPPED.md) | Canonical capability matrix | All | Shipped v0.28 |
...
| [architecture.md](architecture.md) | User-facing ecosystem overview | Evaluator | Shipped v0.28 |
...
| [platform/OVERVIEW.md](https://github.com/eddiethedean/strixonomy/blob/main/docs/platform/OVERVIEW.md) | OntoUI / platform (GitHub) | Implementer | Shipped v0.28 |
