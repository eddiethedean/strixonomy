...
From a git clone, use `cargo run --` or an installed `strixonomy`. Samples below use [`examples/plugin-workspace/`](https://github.com/eddiethedean/strixonomy/tree/v0.26.2/examples/plugin-workspace).
