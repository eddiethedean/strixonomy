...
1. On a connected staging machine, download from [GitHub Releases](https://github.com/eddiethedean/strixonomy/releases) for version **v0.26.2** (or your pinned version):
   - `strixonomy-v0.26.2.vsix` (pattern: `strixonomy-v<version>.vsix`)
   - `SHA256SUMS`
   - `NOTICES`
...
|----------|-------------------|--------------|
| Linux x64 | **Yes** | — |
| macOS | **No** | `cargo install strixonomy-cli --locked --version 0.26.2` (requires Rust on agent) |
