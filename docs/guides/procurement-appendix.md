...
3. Pin `cargo install ontocore-cli --locked --version 0.26.2` (or current [TAGGED_RELEASE](https://github.com/eddiethedean/strixonomy/blob/main/docs/TAGGED_RELEASE)) in CI.
