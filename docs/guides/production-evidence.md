...
- Pin Strixonomy **0.28.1** — `cargo install strixonomy-cli --locked --version 0.28.1` or release binary with SHA256 verification — [release integrity](../release-integrity.md)
