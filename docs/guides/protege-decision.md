...
| Full OWL 2 DL axiom catalog on every format | **Split workflow** — Strixonomy for browse/query/CI/classification + supported authoring; keep Protégé for uncovered axiom types until [v0.30](../roadmap.md) |
...
Do **not** plan org-wide Protégé retirement on v0.29–v0.30 alone. Re-evaluate at **v0.30** against [What ships today](../SHIPPED.md) and [known limitations](../known-limitations.md).
