...
|--------|----------------|
| [`docs/TAGGED_RELEASE`](https://github.com/eddiethedean/strixonomy/blob/main/docs/TAGGED_RELEASE) | Canonical public install version (today: **0.28.1**) |
...
## Recommended installs (v0.28.1)

| Goal | Command / link |
|------|----------------|
| VS Code | Marketplace **or** download `strixonomy-v0.28.1.vsix` from [GitHub Releases](https://github.com/eddiethedean/strixonomy/releases/tag/v0.28.1) |
| Cursor | [Open VSX](https://open-vsx.org/extension/strixonomy/strixonomy) or the same VSIX |
| CLI (pinned) | `cargo install strixonomy-cli --locked --version 0.28.1` |
| CLI (Linux, no compile) | `strixonomy-v0.28.1-x86_64-unknown-linux-gnu.tar.gz` from GitHub Releases |
| Tutorial files (offline) | [`strixonomy-tutorial.zip`](https://github.com/eddiethedean/strixonomy/releases/download/v0.28.1/strixonomy-tutorial.zip) on the same GitHub Release (or curl samples in [First success](first-success.md)) |
...
Exact filenames on [GitHub Release v0.28.1](https://github.com/eddiethedean/strixonomy/releases/tag/v0.28.1) (verify with `SHA256SUMS` on the same release):

| Artifact | Filename |
|----------|----------|
| VS Code / Cursor extension | `strixonomy-v0.28.1.vsix` |
| CLI (Linux x64 only) | `strixonomy-v0.28.1-x86_64-unknown-linux-gnu.tar.gz` |
...
1. Check the [latest GitHub Release](https://github.com/eddiethedean/strixonomy/releases/latest) tag (example: `v0.28.1`).
