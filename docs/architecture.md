...
**Latest tagged: v0.27.0** — v0.27 ships today. **v0.28 in progress** on `main` (compat shim removal). **Strixonomy IDE** (VS Code) + **Strixonomy engine** (CLI / LSP / library) + **Ontologos** (reasoning).
