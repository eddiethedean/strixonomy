...
4. Set `strixonomy.lspPath` to a local `strixonomy-lsp` binary (`cargo install strixonomy-lsp --locked --version 0.26.2`) — trusted workspaces only.
...
| Corporate Marketplace blocked / lag | Install `strixonomy-v0.26.2.vsix` from [GitHub Releases](https://github.com/eddiethedean/strixonomy/releases) — [VS Code install](vscode-install.md) |
