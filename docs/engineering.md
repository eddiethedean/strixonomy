...
| Topic | Path in repo |
|-------|----------------|
| Design / specs index | [`docs/design/README.md`](https://github.com/eddiethedean/strixonomy/blob/main/docs/design/README.md) |
| Engineering ADRs | [`docs/design/adr/`](https://github.com/eddiethedean/strixonomy/tree/main/docs/design/adr) |
| Product ADRs | [`docs/adr/`](https://github.com/eddiethedean/strixonomy/tree/main/docs/adr) |
| Platform architecture (implementers) | [`docs/platform/OVERVIEW.md`](https://github.com/eddiethedean/strixonomy/blob/main/docs/platform/OVERVIEW.md) |
...
- [Engineering ADRs](design/adr/0001-use-rust-for-ontocore.md) (see [ADR index on GitHub](https://github.com/eddiethedean/strixonomy/blob/main/docs/design/adr/README.md))
- [Plugin model](strixonomy/plugin-model.md)
- [Licenses](design/LICENSES.md)
- [Documentation index](https://github.com/eddiethedean/strixonomy/blob/main/docs/documentation-index.md) (GitHub reading-order map)

Capability truth for adopters: **[What ships today](SHIPPED.md)** and **[Known limitations](known-limitations.md)**. For Protégé comparison use **[Protégé vs Strixonomy](guides/protege-decision.md)** — not the historical [design/PROTEGE_PARITY.md](design/PROTEGE_PARITY.md) checklist.
