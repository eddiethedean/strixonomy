...
Index and explore OWL/RDF/OBO, run queries, refactors, and reasoning in VS Code — backed by a native Rust engine and language server.
</p>
...
=== "VS Code"
    ...
    1. Install the **Strixonomy extension** from the [Marketplace](https://marketplace.visualstudio.com/items?itemName=ontocode.ontocode) or [Open VSX](https://open-vsx.org/extension/ontocode/ontocode) (for Cursor)
