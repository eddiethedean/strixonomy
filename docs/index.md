...
**Latest tagged: v0.28.1.** Full capability matrix: **[What ships today](SHIPPED.md)**. For channel lag (Marketplace vs crates.io vs docs), see [Versions & channels](guides/versions-and-channels.md).
...
=== "CI / CLI (optional)"
    ...
    Most IDE users skip this. Prefer the [Linux x64 release tarball](https://github.com/eddiethedean/strixonomy/releases/tag/v0.28.1) for CI — [CI integration](ci-integration.md).
